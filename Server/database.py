...
def validate_student_data(student_data):
    ...
    model_fields = {"modelFunctionalities", "description"}
    ...
    if not isinstance(student_data["links"], list):
        return False, "links should be a list"
    ...
    # Validate types of fields in the model dictionary
    if not isinstance(student_data["model"]["modelFunctionalities"], list):
        return False, "modelFunctionalities should be a list"
